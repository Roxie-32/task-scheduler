                        ...
                        <body >
                            <div class="container">
                                ...
                                <div class="col-xs-12">
                                  ...
                                  <span class="glyphicon glyphicon-edit"></span> Add A task</a> 
                            <a href="delall.php" class="btn btn-danger" style="font-family:'Times New Roman', Times, serif"> 
                            <span class="glyphicon glyphicon-trash"></span>Delete all Tasks</a>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                   <h3 style="text-align: center;
                                    ...
                                    "><strong><span class="glyphicon glyphicon-tasks"></span>MY TASKS</strong></h2>
                                </div>
...
?>
                            ...
                            <!-- <form action="">
                                <input type="button" onclick="window.location.href = 'add.php';" value="Add a task">
                            </form> -->
                        </body>
                    </html>
